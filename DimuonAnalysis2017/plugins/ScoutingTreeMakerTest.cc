...
class ScoutingTreeMakerTest : public edm::one::EDAnalyzer<edm::one::SharedResources, edm::one::WatchRuns, edm::one::WatchLuminosityBlocks> {
	public:
		explicit ScoutingTreeMakerTest(const edm::ParameterSet&);
		~ScoutingTreeMakerTest();
...
ScoutingTreeMakerTest::ScoutingTreeMakerTest(const edm::ParameterSet& iConfig): 
...
ScoutingTreeMakerTest::~ScoutingTreeMakerTest() {
}

void ScoutingTreeMakerTest::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
    using namespace edm;
    using namespace std;
...
void ScoutingTreeMakerTest::beginJob() {
...
void ScoutingTreeMakerTest::endJob() {
}

void ScoutingTreeMakerTest::beginRun(edm::Run const& iRun, edm::EventSetup const& iSetup) {
    // HLT paths
...
void ScoutingTreeMakerTest::endRun(edm::Run const&, edm::EventSetup const&) {
}

void ScoutingTreeMakerTest::beginLuminosityBlock(edm::LuminosityBlock const& iLumi, edm::EventSetup const&) {
}

void ScoutingTreeMakerTest::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&) {
}

void ScoutingTreeMakerTest::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
	edm::ParameterSetDescription desc;
	desc.setUnknown();
	descriptions.addDefault(desc);
}

DEFINE_FWK_MODULE(ScoutingTreeMakerTest);
